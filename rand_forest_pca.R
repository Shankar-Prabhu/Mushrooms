...
rand_for = randomForest(class_p ~., data = train_pca_final, importance = TRUE)

train_preds = predict(rand_for, train_pca_final, type = "class")
test_preds = predict(rand_for, test_pca_final, type = "class")
